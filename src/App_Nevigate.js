...
import ThemeListPage from './ThemeListPage'; // Import the ThemeListPage component
import './App.css';
      ...
      <div className="container mt-4">
        ...
        <main className="row mt-4">
          <section className="col-md-6">
            ...
            <button className="btn btn-primary mt-3" onClick={fetchSuggestions}>
              Get Suggestions
            </button>
          </section>
          <section className="col-md-6">
            ...
            <div className="card p-3">
              ...
              />
              <label htmlFor="interest" className="form-label mt-3">
                Interest:
              </label>
              <textarea
                id="interest"
                ...
                className="form-control"
              />
              <button className="btn btn-success mt-3" onClick={saveTheme}>
                Save Theme
              </button>
            </div>
          </section>
        ...
        <footer className="mt-4 text-center">
          <p>
            &copy; 2023 Theme App |{' '}
            <Link to="/theme-list" className="text-white">
              View Theme List
            </Link>
          </p>
        </footer>
